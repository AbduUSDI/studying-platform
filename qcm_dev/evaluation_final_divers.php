...
$questions = $questionHandler->getQuestionEvaluationFinaleLangages();
shuffle($questions);
$selectedQuestions = array_slice($questions, 0, 100);

$_SESSION['questions'] = $selectedQuestions; // Stocker les questions dans la session.

// Définir la catégorie pour ce QCM
$category = "Evaluation finale - Langages"; // Modifier ici selon la catégorie du QCM
?>
...
<div class="container mt-5">
    ...
    <h1 class="text-center mb-4 text-primary">QCM - Evaluation finale sur les langages de programmations</h1>
