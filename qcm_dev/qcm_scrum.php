...
$questions = $questionHandler->getQuestionQCMScrum();
...
<head>
    ...
    <title>QCM - Méthodologie SCRUM</title>
...
<div class="container mt-5">
    ...
    <h1 class="text-center mb-4 text-primary">QCM - Méthodologie SCRUM</h1>
