...
$questions = $questionHandler->getQuestionQCMSQL();
...
$category = "SQL - Base de données relationnelle";
?>
...
<head>
    ...
    <title>QCM - SQL - Base de données relationnelle</title>
...
<div class="container mt-5">
    ...
    <h1 class="text-center mb-4 text-primary">QCM - SQL - Base de données relationnelle</h1>
