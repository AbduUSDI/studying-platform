...
$questions = $questionHandler->getQuestionQCMJS();
...
$category = "JavaScript - Le couteau suisse des dev";
?>
...
<div class="container mt-5">
    ...
    <h1 class="text-center mb-4 text-primary">QCM - JavaScript, le couteau suisse du Dev</h1>
