...
$questions = $questionHandler->getQuestionQCM7();
...
$category = "Les bonnes pratiques de code"; // Modifier ici selon la catégorie du QCM
?>
...
<head>
    ...
    <title>QCM - Les bonnes pratiques de code</title>
...
<div class="container mt-5">
    ...
    <h1 class="text-center mb-4 text-primary">QCM - Les bonnes pratiques de code</h1>
...
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>QCM - Points techniques approfondis</title>
    <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/4.5.2/css/bootstrap.min.css">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0-beta3/css/all.min.css">
    <link rel="stylesheet" href="assets/css/style.css"/>
    <link rel="stylesheet" href="/Portfolio/cours/assets/css/exercice.css"/>
...
<div class="container mt-5">
<?php include_once 'retour.php'; ?>
    <h1 class="text-center mb-4 text-primary">QCM - Points techniques approfondis</h1>
    <form action="index.php?page=qcm_dev/save_score" method="POST" id="qcm-form">
        <div class="row">
            <?php foreach ($selectedQuestions as $index => $question): ?>
                <div class="col-md-12 mb-4">
